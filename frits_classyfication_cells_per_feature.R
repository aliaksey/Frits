...
load("alp_data.RData")
library(ggplot2)
cell_plot<-alp_data[,c("FeatureIdx","ImageNumber",
                        "ObjectNumber","Cells_AreaShape_Compactness",
...
ggplot(cell_plot.f,aes(Cells_AreaShape_Solidity,
   Cells_AreaShape_Compactness,colour=as.factor(Class)))+geom_point()
boxplot(cell_plot.f$ALPCytoplasm_Intensity_IntegratedIntensity_ALP4Corr~cell_plot.f$Class)
boxplot(cell_plot.f$ALP_Int_scale~cell_plot.f$Class)

ggplot(cell_plot.f,aes(Cells_AreaShape_Solidity,
    Cells_AreaShape_Compactness,colour=ALPCytoplasm_Intensity_IntegratedIntensity_ALP4Corr))+geom_point()+
...
boxplot(cell_plot.rf$ALPCytoplasm_Intensity_IntegratedIntensity_ALP4Corr)
boxplot(cell_plot.rf$ALP_Int_scale)

ggplot(cell_plot.rf,aes(Cells_AreaShape_Solidity,
                       Cells_AreaShape_Compactness,colour=ALPCytoplasm_Intensity_IntegratedIntensity_ALP4Corr))+geom_point()+
  scale_colour_gradient2(limits=c(0, 1000),low="yellow", high="blue")

ggplot(cell_plot.rf,aes(Cells_AreaShape_Solidity,
                       Cells_AreaShape_Compactness,colour=ALP_Int_scale))+geom_point()+
  scale_colour_gradient2(limits=c(0, 2),low="yellow", high="blue")
